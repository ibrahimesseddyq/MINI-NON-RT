...
{
    FLOAT dot_product = vector_dot(normal, incident);
    t_vector scaled_normal = vector_scale(normal, 2.0 * dot_product);
    t_vector reflection = vector_sub(incident, &scaled_normal);
    return reflection;
}
